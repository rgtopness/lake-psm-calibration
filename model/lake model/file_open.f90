...
!     output files
      ...
      if (tlake_profile) then
         ...
         if (tlake_print(2).eq.-999) then
           write(51,"(1000(3x,i3,2x))") (j,j=tlake_print(1),max_dep,tlake_print(3))
         else
           write(51,"(1000(3x,i3,2x))") (j,j=tlake_print(1),tlake_print(2),tlake_print(3))
         endif
      endif
      ...
      if (tsed_profile) then
         ...
         write(52,"(a12,1000(3x,i3,2x))") "YEAR MON DAY",(j,j=tsed_print(1),tsed_print(2),tsed_print(3))
      endif
      ...
      if (d18O_profile) then
         ...
         if (d18O_print(2).eq.-999) then
           write(53,"(1000(3x,i3,2x))") (j,j=d18O_print(1),max_dep,d18O_print(3))
         else
           write(53,"(1000(3x,i3,2x))") (j,j=d18O_print(1),d18O_print(2),d18O_print(3))
         endif
      endif
      ...
      if (d2H_profile) then
         ...
         if (d2H_print(2).eq.-999) then
           write(54,"(1000(4x,i3,2x))") (j,j=d2H_print(1),max_dep,d2H_print(3))
         else
           write(54,"(1000(4x,i3,2x))") (j,j=d2H_print(1),d2H_print(2),d2H_print(3))
         endif
      endif
      ...
      if (salty_profile) then
         ...
         if (salty_print(2).eq.-999) then
           write(55,"(1000(3x,i3,2x))") (j,j=salty_print(1),max_dep,salty_print(3))
         else
           write(55,"(1000(3x,i3,2x))") (j,j=salty_print(1),salty_print(2),salty_print(3))
         endif
      endif
